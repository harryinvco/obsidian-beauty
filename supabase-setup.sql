...
-- Note: These policies allow full access to the service role key
-- In production, you may want more restrictive policies

CREATE POLICY "Allow service role full access to beauty_leads" 
ON beauty_leads 
FOR ALL 
TO service_role 
USING (true) 
...
CREATE POLICY "Allow service role full access to saas_leads" 
ON saas_leads 
FOR ALL 
TO service_role 
USING (true) 
...
CREATE POLICY "Allow service role full access to ecom_leads" 
ON ecom_leads 
FOR ALL 
TO service_role 
USING (true) 
